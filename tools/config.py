...
app_flags_table = {
      ...
      "cholesky"                                   : "-p64 ./tests/benchmarks/cholesky/inputs/tk29.O",
      "barnes"                                     : "\< ./tests/benchmarks/barnes/inputs/input.65536.64",
      "fmm"                                        : "\< ./tests/benchmarks/fmm/inputs/input.65536.64",
      "ocean_contiguous"                           : "-p64 -n1026",
      "ocean_non_contiguous"                       : "-p64 -n1026",
      "water-spatial"                              : "\< ./tests/benchmarks/water-spatial/input",
      "water-nsquared"                             : "\< ./tests/benchmarks/water-nsquared/input",
      "raytrace"                                   : "-p64 -m64 ./tests/benchmarks/raytrace/inputs/car.env",
      "volrend"                                    : "64 ./tests/benchmarks/volrend/inputs/head",
