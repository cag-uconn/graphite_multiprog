...
{
public:
   static UInt32 getDirectoryType()    { return _directory_type; }
   static SInt32 getMaxHWSharers()     { return _max_hw_sharers; }
   static SInt32 getMaxNumSharers()    { return _max_num_sharers; }

   static void setDirectoryType(UInt32 directory_type)      { _directory_type = directory_type; }
